...
export default function Home() {
  ...
  const fetchArtworks = async () => {
    ...
    try {
      ...
      const res = await axios.get(`${API_BASE}/api/artworks`, { params });
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', marginBottom: '40px', flexWrap: 'wrap' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
          ...
          <select
            ...
            style={{
              border: '2px solid #a85f18', borderRadius: '999px',
              padding: '10px 24px', fontSize: '0.95rem',
              color: '#3b1f0e', background: 'white',
