    ...
    <div style={{ minHeight: '90vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ color: '#a85f18', fontSize: '0.9rem' }}>Share your story with the world</p>
        </div>
        ...
        <div style={{ backgroundColor: 'white', borderRadius: '24px', padding: '32px', boxShadow: '0 4px 24px rgba(59,31,14,0.1)' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            <div>
              ...
              <input type="text" name="username" value={form.username} onChange={handleChange} placeholder="yourname" style={inputStyle} />
            </div>
            <div>
          ...
          <p style={{ textAlign: 'center', fontSize: '0.88rem', color: '#a85f18', marginTop: '20px' }}>
            ...
            <Link to="/login" style={{ color: '#3b1f0e', fontWeight: '700', textDecoration: 'none' }}>Log In</Link>
          </p>
        </div>
