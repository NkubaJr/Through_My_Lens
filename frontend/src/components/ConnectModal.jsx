  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await axios.post(
        `http://localhost:5000/api/artworks/${artwork.artwork_id}/support`,
        {
      ...
      >
        <div style={{ marginBottom: '24px' }}>
          <h3 style={{
            ...
            color: '#3b1f0e', marginBottom: '4px'
          }}>
            Connect with {artwork.username}
          </h3>
          <p style={{ color: '#a85f18', fontSize: '0.88rem' }}>
            Reach out about "{artwork.title}"
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={4}
              placeholder="Tell the artist why you love their work and how you'd like to connect..."
